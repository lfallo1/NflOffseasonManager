...
angular.module('nflDraftApp', ['ngRoute', 'ngAnimate', 'angular-storage', 'angularjs-dropdown-multiselect', 'youtube-embed', 'ui.bootstrap', 'toaster', 'ngClipboard', 'rzModule', 'angucomplete-alt', 'ngStomp'])
