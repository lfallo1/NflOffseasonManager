...
@Service
public class StudentsRepository extends JdbcDaoSupport implements PlayerSql {

	public StudentsRepository(@Autowired @Qualifier("Students") DataSource dataSource) {
		setDataSource(dataSource);
	}

	public List<String> find() throws DatabaseException {
		return getJdbcTemplate().query("select * from student", new RowMapper<String>(){
